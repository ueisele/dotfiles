# Generated by Powerlevel10k configuration wizard on 2020-09-24 at 18:00 UTC.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='λ' # default char is '❯'
  # Prompt symbol in command vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION='❮' # default char is '❮'
  # Prompt symbol in visual vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_CONTENT_EXPANSION='V' # default char is 'V'
  # Prompt symbol in overwrite vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIOWR_CONTENT_EXPANSION='▶' # default char is '▶'
  ...
  function prompt_container_context() {
    local container_context="$(_determine_container_context)"
    if [ -n "${container_context}" ]; then
      p10k segment -t "%246Fon %190F${container_context}"
    fi
  }
  ...
  function _determine_container_context() {
    if _is_codespaces; then
      printf 'Codespaces'
    elif _is_remote_containers; then
      printf 'Remote Containers'
    elif _is_in_container; then
      printf 'Docker'
    fi
  }

  function _is_codespaces () {
      [ "${CODESPACES}" = "true" ]
  }

  function _is_remote_containers () {
